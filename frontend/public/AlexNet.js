...
function AlexNet(graphContainer, darkMode) {

    // /////////////////////////////////////////////////////////////////////////////
    //                       ///////    Variables    ///////
    // /////////////////////////////////////////////////////////////////////////////

    var w = document.getElementById("main-container").clientWidth - 50;
    var h = 350;
    ...
    var textColor = 'rgba(0, 0, 0, 1.0)';
    var lineColor = "#000000";
    var backgroundColor = "#ffffff";

    let darkBackgroundColor = "#1E1E1E";
    let darkLineMaterial = "#aaaaaa";
    let darkArrowColor = "#aaaaaa";
    let darkTextColor = "#aaaaaa";
    let color1Dark = "#555555";
    let color2Dark = "#0D47A1"
    let color3Dark = "#EF5350";

    if (darkMode) {
        backgroundColor = darkBackgroundColor;
        lineColor = darkLineMaterial;
        textColor = darkTextColor;
        arrowColor = darkArrowColor;
        color1 = color1Dark;
        color2 = color2Dark;
        color3 = color3Dark;
    }
    ...
    var line_material = new THREE.LineBasicMaterial({ 'color': lineColor });
    ...
    function restartRenderer({ rendererType_ = rendererType } = {}) {
        ...
        graph_container = document.getElementById(graphContainer)
    ...
    function redraw({ architecture_ = architecture,
        ...
        // initial positioning for centering when upscaling
        // console.log(layer_offsets.length)
        ...
        architecture2.forEach(function (layer, index) {
            ...
            headWidth = 5;
            arrow = new THREE.ArrowHelper(direction, origin, length, arrowColor, headLength, headWidth);
            pyramids.add(arrow);
    ...
    function onWindowResize() {
        ...
        w = document.getElementById("main-container").clientWidth - 50;
        renderer.setSize(w, h);

        camFactor = window.devicePixelRatio || 1;
        camera.left = -w / camFactor / 5;
        camera.right = w / camFactor / 5;
        camera.top = h / camFactor / 5;
        camera.bottom = -h / camFactor / 5;
        camera.updateProjectionMatrix();
